 ...
 */
public abstract class PlacesSource {
	
	  public static final String TAG = "PlacesSource";
     ...
     */
    private HashMap<String, DataKind> mMimeKinds = new HashMap<String, DataKind>();
    ...
    public synchronized void ensureInflated(Context context, int inflateLevel) {
    	  ...
    	  //Log.i(TAG, "ensureInflated: inflateLevel " + inflateLevel);
    ...
    public ArrayList<DataKind> getSortedDataKinds() {
        // TODO: optimize by marking if already sorted
    	  Log.i("PlacesSource", "getSortedDataKinds()");
...
//        public int actionAltRes;
    ...
    public static class EditField {
        ...
        public EditField setExtra1(String extra) {
        	this.extra1 = extra;
        	return this;
        }
        
        public EditField setExtra2(String extra) {
        	this.extra2 = extra;
        	return this;
        }
    }
